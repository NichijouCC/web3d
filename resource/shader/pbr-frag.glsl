...
// debugging flags used for shader output of intermediate PBR letiables
...
// Encapsulate the letious inputs used by the letious functions in the shading equation
