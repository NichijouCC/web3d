...
(function (dome) {
    class testSeralize {
        start() {
            let quad = web3d.assetMgr.load("resource/mesh/quad.mesh.bin");
            let mat0 = web3d.assetMgr.load("resource/mat/diff.mat.json");
            let obj1 = new web3d.GameObject();
            obj1.name = "obj1";
            let meshf = obj1.addComponent("MeshFilter");
            ...
            obj2.name = "obj2";
            let meshf2 = obj2.addComponent("MeshFilter");
            let meshr2 = obj2.addComponent("MeshRender");
            meshf2.mesh = quad;
    ...
    dome.testSeralize = testSeralize;
})(dome || (dome = {}));
